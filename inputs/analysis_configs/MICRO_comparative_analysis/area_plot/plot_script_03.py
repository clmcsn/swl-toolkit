...
sns.lineplot(x='cfg', y='area', hue='ports', hue_order=[1,2,3,4,0], markers=True, style='ports', style_order=[1,2,3,4,0], data=area_df.loc[area_df['l3cache'] == 1], ax=axs[0], palette='tab10',markersize=9)
...
sns.lineplot(x='cfg', y='area_ratio', hue='ports', style='ports', markers=True, data=child_area_df.loc[child_area_df['l3cache'] == 1], ax=axs[1],palette='tab10', markersize=8)
...
output_file = output_dir + "05_02_AREA2"
